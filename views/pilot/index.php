	...
	<div class="clearfix crud-navigation">
		...
		?>
			<div class="pull-left">
				...
				<?= Html::a('<span class="glyphicon glyphicon-phone"></span> ' . 'Setup SMS Contacts', ['/sms/synch-sms', 'contest_id'=>\yii::$app->user->identity->profile->contest_id], ['class' => 'btn btn-danger']) ?>
