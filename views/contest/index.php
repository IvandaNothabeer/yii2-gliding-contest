				...
				[
					...
					'dropdown' => [
						...
						'items' => [
							[
								'url' => ['club/index'],
								'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Clubs'),
							],
							[
								'url' => ['pilot/index'],
								'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Pilots'),
							],
							[
								'url' => ['person/index'],
								'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'People'),
							],
							[
								'url' => ['towplane/index'],
								'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Towplanes'),
							],
							[
								'url' => ['transaction-type/index'],
								'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Prices'),
							],
